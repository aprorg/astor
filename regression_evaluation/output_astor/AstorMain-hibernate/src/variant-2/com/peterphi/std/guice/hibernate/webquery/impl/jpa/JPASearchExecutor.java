...
public class JPASearchExecutor {
	...
	public <T> com.peterphi.std.guice.hibernate.webquery.ConstrainedResultSet<T> find(final com.peterphi.std.guice.hibernate.webquery.impl.QEntity entity, final 
	com.peterphi.std.guice.restclient.jaxb.webquery.WebQuery query, 
	com.peterphi.std.guice.hibernate.webquery.impl.jpa.JPASearchStrategy strategy, 
	java.util.function.Function<?, ?> serialiser) 
	{
		final com.peterphi.std.guice.hibernate.module.logging.HibernateSQLLogger statementLog;

		if (query.isLogSQL())
			statementLog = hibernateObserver.startSQLLogger();else
